...
### Semaine 5
Après l'éclat du combat précédent, cette cinquième rixe, bien moins intense, nous fit l'effet d'une bouffée d'air si fraîche qu'elle en paraissait divine. Lors de celle-ci, nous décidâmes de séparer les cauchemars ailés créés la semaine précédentes en deux famille distinctes, tel Épiméthée façonnant son Œuvre  : celles ayant la capacité supplémentaire inouïe de traverser les murs et autres objets ayants des collisins, et celles qui en resteraient incapable. De plus, sous l'influence de pressions extérieures, nous nous mîmes à développer une batterie de tests en tou genre, ayants pour but de nous permettre une détection automatique de problèmes inattendus si d'aventures la mise en pratique de l'une de nos inspirations, évidemment toujours plus brillantes au fur et à mesure de notre aventure, venait, de quelque manière que ce soit, à contrarier ne serait-ce que partiellement l'exécution d'autres fonctionnalités implémentés précédemment. Ainsi s'acheva la quinte étape de notre projet.
### Semaine 6, 7 & 8
Un cessez-le-feu fut prononcé pour quelques jours, afin de nous laisser l'occasion de nous préparer, que ce soit mentalement ou physiquement, en vue de l'examen de mi-semestre. Ainsi s'achevèrent les sixte, setime et oitisme étapes de notre projet, avant même d'avoir commencé.
### Semaine 9
Pour cette reprise des hostilités, nous revînmes plein d'espoirs et d'idées nouvelles et nous jetâmes à nouveau à corps perdu dans la bataille. Notre première initiative fut, pour rendre la carte un brin plus organique, de rajouter des plateformes mobiles, se mouvant par groupes de blocs adjacent, innovation qui multiplia sensiblement les possibilités de niveau et étendit grandement nos horizons en terme de level design. Ensuite, il nous vint à l'esprit que des sortes de barrières à ouvrir, qui forceraient donc notre valeureux héros à effectuer certains détours, potentiellement mortels, afin de pouvoir continuer à avancer, pourraient également nous être d'une utilité non négligeable lors de la réalisation de nos niveaux. Nous implémentâmes donc des portails, qui empêchaient tout passage lorsque fermés, disparaissaient lorsque ouverts, et qui pourraient être contrôlés uniquement à distance à l'aide d'interrupteur, activables avec les armes (épée, arc et flèches). Ces précieuses trouvailles rendîment ainsi notre épopée bien plus vivante, ce qui était justement l'objectif que nous poursuivions à cet instant-là. Ainsi s'acheva la noefme étape de notre projet. 
### Semaine 10
En cette dixième itération de nos hostilités hebdomadaires, nous complétâmes tout d'abord nos ajouts précédants par des tests, comme décrit ci-dessus. De plus, nous entreprîmes la remarquablement complexe et périlleuse tâche de mesurer les performances de notre programme, dangereuse voltige dont le but final était, sans conteste, d'être en capacité de réunir toute ces données instructives dans un tableur d'une qualité des plus inégalées, afin de pouvoir supporter par l'expérience lka véracité de nos calculs quand à la complexité de nos algorithme de mise en place et de mise à jour de carte. Enfin, il nous fallu, une fois de plus parmis tant d'autres, innover. Nous tranchâmes donc, après une réflexion plus étendue encore qu'un repas de Noël dans une vraie famille française, donc plus de dix heures, qu'il nous semblait acceptable d'introduire deux des illuminations supplémentaires dont nous avions encore bénéficiés depuis la dernière fois. Nous allions donc mettre en place des blocs invisibles, sans collisions, mais faisant partie des groupes de plateformes, afin que les cartes en yaml ne ressemblent pas à un champ vectoriel complet dès que quelques groupes se mouvaient séparément, mais de manière synchronisée. Et la deuxième idée retenue, la plus follement burlesque, la plus immensément gargantuesque que nous ayions eu jusqu'à présent, était d'implémenter un système de point de vie au jeu, pour les ennemis comme pour le héros, et tout ce que cette grave décisions impliquait, telle que les barres de vie, les périodes d'invincibilité et le recul. Ainsi s'acheva la disme étapes de notre projet.
### Semaine 11
Cette altercation-ci fut loin d'être la plus violente, mais, tous, nous retenions nos souffles, car elle servit surtout de préparation au long et lourd combat qui nous attendais. Nous implémentâmes, avec bien plus de facilité qu'attendu, les blocs invisibles précédemment décris, puis nous nous rendîmes comptent que les flèches se bloquaient parfois dans les airs, ce que, de bonne foi, nous pouvons reconnaître comme non intentionnel. Nous corrigeâmes donc cette très perturbante anomalie, puis nous penchâmes sur les limites des cartes. En effet, si notre vaillant protagoniste en venait à trébucher et choir dans l'un des ravins disposés en travers de sa route, il était condamné à chuter indéfiniment, sans aucun espoir d'absolution ou de rédemption possible. Dans notre grande magnaminité, nous entreprîmes donc la mise en place d'une "barrière magique", seuil vertical invisible qui pulvériserait les êtres vivants (surtout à caractère héroique) au contact, ce qui permis d'accorder le repos au malheureux qui, autrement, auraient eu droit à un châtiment semblable aux plaines grises et nues l'Asphodèle, qu'importe leurs vertues. Ainsi s'acheva l'onzaine étape de notre projet.
...
- affichage (blocs, pièces et monstres)
- effets sonores (pièces, sauts et mort)
- système de caméra plus doux
### Semaine 2
- génération de carte
- mouvement des blobs
### Semaine 3
- classe parente Monster
- système de niveau
- score du joueur
- ajout de l'épée
### Semaine 4
...
### Semaine 5
- correction de bugs bloquant les chauves-souris sur place
- ajout d'une sous-classe de chauve-souris qui, elle, ne traverse pas les murs
- mise en place des tests
### Semaine 6, 7 & 8
- midterm
### Semaine 9
- implémentation des plateformes mouvantes
- implémentation des portails et interrupteurs
### Semaine 10
- tests plateformes, portails et interrupteurs
- benchmarking, tests de performances
- analyses de complexité
- choix d'ajout : barre de vie
- choix d'ajout : blocs invisibles
### Semaine 11
- implémentation des blocs invisibles
- traitement du cas des flèches sur blocs qui bougent
- mort en dessous de la map
### Semaine 12
- implémentation du système de barre de vie (PV, frames d'invincibilité, dégats bruts, système de knockback)
### Semaine 13
- correction de bugs, comme l'absence de trois quart de la hitbox des portails commençant ouverts
- diagramme d'héritage
### Semaine 14
- correction de bugs, comme la bonne mise à zéro de la vitesse lors de la mort
- interface barre de vie, score et armes
- polissage du projet